...
{
    CGPoint _oriScrollViewContentOffset;
    UIEdgeInsets _oriScrollViewContentInset;
}
...
#warning 这里数据有问题，只是特例，没有找到合适的办法解决，会有下拉没有停在加载圈圈的bug，所以出此下策
    _oriScrollViewContentOffset.y = -64.0f;
    _oriScrollViewContentInset.top = 64.0f;
	...
	switch (_state = state) {
		case RefreshStatePulling:
        {
            ...
            [UIView animateWithDuration:0.2 animations:^{
                ...
                inset.top = _oriScrollViewContentInset.top;
		...
		case RefreshStateRefreshing:
        {
            ...
            [UIView animateWithDuration:0.2 animations:^{
                // 1.顶部多出65的滚动范围
                UIEdgeInsets inset = _scrollView.contentInset;
                inset.top = kViewHeight + _oriScrollViewContentInset.top;
                _scrollView.contentInset = inset;
                // 2.设置滚动位置
                _scrollView.contentOffset = CGPointMake(0, -kViewHeight + _oriScrollViewContentOffset.y);
            }];
			break;
        }
	}
